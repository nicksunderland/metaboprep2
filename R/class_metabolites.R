...
Metabolites <- new_class(
  ...
  properties = list(
    ...
    feature_missingness       = new_property(class_numeric, default=0.2, validator = function(value) if (is.na(value) || data.table::between(value, 0, 1)) NULL else "should be a value between 0 and 1, inclusive"),
    sample_missingness        = new_property(class_numeric, default=0.2, validator = function(value) if (is.na(value) || data.table::between(value, 0, 1)) NULL else "should be a value between 0 and 1, inclusive"),
    ...
    tree_cut_height           = new_property(class_numeric, default=0.5, validator = function(value) if (is.na(value) || value>=0) NULL else "should be a value >=0"),
