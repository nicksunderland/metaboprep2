...
sample_size_table <- lapply(dimnames(metabolites@data)[[3]], function(layer_name) {
  ...
  data <- get_data(metabolites, layer=layer_name, apply_exclusions = TRUE)
...
```{r qcd_data}
raw_data <- get_data(metabolites, layer="raw", apply_exclusions=TRUE)
qc_data  <- get_data(metabolites, layer="post_qc", apply_exclusions=TRUE)
```
...
```{r power_exploration}
p1 = continuous_power_plot( mydata = get_data(metabolites, layer="post_qc", apply_exclusions = TRUE) ) 
p2 = imbalanced_power_plot( mydata = get_data(metabolites, layer="post_qc", apply_exclusions = TRUE) )
